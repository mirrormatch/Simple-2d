...
public class TilemapInspector : Editor {
	...
	void DrawSelectionRect(Rect texBounds, int idx) {
		...
		rectVerts[0].x = bp.x; 				rectVerts[0].y = bp.y;
		rectVerts[1].x = bp.x + pxPerTileX; rectVerts[1].y = bp.y;
		rectVerts[2].x = bp.x + pxPerTileX; rectVerts[2].y = bp.y + pxPerTileY;
		rectVerts[3].x = bp.x; 				rectVerts[3].y = bp.y + pxPerTileY;
